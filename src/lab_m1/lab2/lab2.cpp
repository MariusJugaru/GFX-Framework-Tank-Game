...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(1, 0, -0.58f), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(-1, 0, -0.58f), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(0, 0, 1.15), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(0, 1.63f, 0), glm::vec3(1, 0, 1)),
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.5f, 0.5f, 0.5f)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.5f, 0.5f, 0.5f)),
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 1.15f), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(1, 0, -0.58f), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(0, 1.63f, 0), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(0, 0, 1.15f), glm::vec3(0, 1, 1)),
            VertexFormat(glm::vec3(0, 1.63f, 0), glm::vec3(0, 1, 1)),
            VertexFormat(glm::vec3(-1, 0, -0.58f), glm::vec3(0, 1, 1)),
            VertexFormat(glm::vec3(-1, 0, -0.58f), glm::vec3(1, 1, 0)),
            VertexFormat(glm::vec3(1, 0, -0.58f), glm::vec3(1, 1, 0)),
            VertexFormat(glm::vec3(0, 1.63f, 0), glm::vec3(1, 1, 0)),
            VertexFormat(glm::vec3(1, 0, -0.58f), glm::vec3(0.5f, 0.5f, 0.5f)),
            VertexFormat(glm::vec3(-1, 0, -0.58f), glm::vec3(0.5f, 0.5f, 0.5f)),
            VertexFormat(glm::vec3(0, 0, 1.15f), glm::vec3(0.5f, 0.5f, 0.5f)),
        ...
        // Actually create the mesh from the data
        CreateMesh("tetra_color", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexNormal"], glm::vec3(1, 0, 0), glm::vec3(1));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-1, 1, -1), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-0.5, 1, -2), glm::vec3(1));

    RenderMesh(meshes["tetra_color"], shaders["VertexColor"], glm::vec3(2, 1, -2), glm::vec3(1));
